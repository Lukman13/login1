<div class="modal fade " id="tambahdata1" tabindex="-1" role="dialog" aria-labelledby="tambahdata1Label" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <input type="text" class="form-control" id="nama" name="nama" placeholder="lukman">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary" id="input1">Add</button>
            </div>
